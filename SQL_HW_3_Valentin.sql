...
--- 5. Найти всех работников кому не начислена ЗП. left				НЕ ПОНЯЛ КАК ВЫВЕСТИ ЗП

select employee_name  from employees 								--salary_id
left join employee_salary on employees.id = employee_salary.employee_id
where salary_id is null;

--- 6. Вывести всех работников с названиями их должности.	вывести 70 из них у 30 null
...
--- 7. Вывести имена и должность только Java разработчиков.		like '%Java developer%'
...
--- 9. Вывести имена и должность всех QA инженеров.		all QA
...
--- 22. Вывести сумму зарплат JS разработчиков				select sum()
...
--- 29. Вывести имена, должности и ЗП всех специалистов по возрастанию	//зп по возрастанию order by monthly_salary
...
--у специалистов у которых ЗП от 1700 до 2300 between
...
--у специалистов у которых ЗП равна 1100, 1500, 2000      --in()
